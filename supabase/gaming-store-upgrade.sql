...
-- Run only in an existing Unique CD House Supabase project, never Hamza Dental.
...
declare
  ...
  v_total numeric(12,2):=0; v_item jsonb; v_product public.products%rowtype; v_product_id uuid; v_qty integer;
begin
